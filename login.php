...
?>
    <div class="container">
      ...
      <div class="row">
        <form class="form-horizontal col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3" action="login2.php" method="post">
          <fieldset>
            <legend>Login</legend>
